...
public class ContaInvestimento extends Conta {
    ...
    public ContaInvestimento(String numero, double saldo, IRendimento rendimento, ITaxas taxas, EPessoa pessoa) {
        super(numero, saldo, rendimento, taxas, pessoa, ETipoConta.INVESTIMENTO);
    }
}